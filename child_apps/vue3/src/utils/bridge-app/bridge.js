 ...
 * @LastEditTime: 2022-09-01 15:33:25
 * @FilePath: \vue3\src\utils\bridge-app\bridge.js
...
export default class Bridge {
   ...
   */
  connect() {
    console.log("开始监听全局信息");
    const onMessage = (message) => {
      console.log("子应用来消息了", message);
      const { topic = "", payload = {} } = message;
      console.log("this._subscriberList", this._subscriberList);
